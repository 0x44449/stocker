...
@Entity
@Table(name = "stock_price_realtime_raw")
@IdClass(StockPriceRealtimeRawId.class)
public class StockPriceRealtimeRawEntity {
    ...
    public StockPriceRealtimeRawEntity() {}

    public StockPriceRealtimeRawEntity(LocalDate trdDd, String market, String stockCode, String stockName,
                                       LocalDateTime capturedAt, Long close, Long diff, BigDecimal diffRate,
                                       Long open, Long high, Long low, Long volume, Long value,
                                       Long marketCap, Long listedShares, String source) {
        this.trdDd = trdDd;
        this.market = market;
